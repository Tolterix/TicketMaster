  ...
  return knex('tickets').del()
    .then(function () {
      ...
      return knex('tickets').insert([
        ...
        {id: 3, guid: 3456789, status: 3, title: 'I can\'t access the share drives', description: 'the print drive and share drive are not on my computer anymore', category_id: 7, submitted_by: 5}
      ]);
    });
};
